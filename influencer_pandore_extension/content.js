...
function injectButton(platform) {
  ...
  try {
    if (platform === "Facebook") {
      const facebookXPath = "/html/body/div[1]/div/div[1]/div/div[3]/div/div/div[1]/div[1]/div/div/div[1]/div[2]/div/div/div/div[3]/div/div/div[2]";
      targetElement = getElementByXPath(facebookXPath);
    } else if (platform === "Instagram") {
      const instagramXPath = "/html/body/div[2]/div/div/div[2]/div/div/div[1]/div[2]/div/div[1]/section/main/div/header/section[4]/div";
      targetElement = getElementByXPath(instagramXPath);
    } else if (platform === "X") {
      const xXPath = "/html/body/div[1]/div/div/div[2]/main/div/div/div/div[1]/div/div[3]/div/div/div/div/div[3]";
      targetElement = getElementByXPath(xXPath);
    } else if (platform === "LinkedIn") {
      const linkedinXPath = "/html/body/div[6]/div[3]/div/div/div[2]/div/div/main/section[1]/div[2]/div[2]";
      targetElement = getElementByXPath(linkedinXPath);
    } else if (platform === "TikTok") {
      const tiktokXPath = "/html/body/div[1]/div[2]/div[2]/div/div/div[1]/div[2]/div[3]/h2";
    ...
    if (targetElement && !document.getElementById("getData")) {
      ...
      button.style.backgroundColor = platform === "X" ? "#1da1f2" : platform === "Instagram" ? "#E1306C" : platform === "Facebook" ? "#1877F2" : platform === "LinkedIn" ? "#0077B5" : platform === "TikTok" ? "#FE2C55" : "#000";
      ...
      button.addEventListener("mouseenter", () => {
        button.style.backgroundColor = platform === "X" ? "#1a91da" : platform === "Instagram" ? "#c82357" : platform === "Facebook" ? "#155cbd" : platform === "LinkedIn" ? "#005f8e" : platform === "TikTok" ? "#EA284E" : "#333";
      });
      ...
      button.addEventListener("click", () => {
        ...
        chrome.runtime.sendMessage({ action: "fetchData", platform: platform }, (response) => {
